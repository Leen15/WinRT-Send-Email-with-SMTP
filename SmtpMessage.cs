...
namespace SmtpMail
{
    ...
    public class SmtpMessage
    {
        ...
        public new String FromName { get; set; }
        public new String ReplyTo { get; set; }
        public new String ReplyToName { get; set; }
...
public String GetBody()
{
    ...
    sb.AppendFormat("From: {0} <{1}>{2}", FromName, From, System.Environment.NewLine);

    if (!string.IsNullOrEmpty(ReplyTo))
    {
        sb.AppendFormat("Reply-To: {0} <{1}>{2}", ReplyToName, ReplyTo, System.Environment.NewLine);   
    }
